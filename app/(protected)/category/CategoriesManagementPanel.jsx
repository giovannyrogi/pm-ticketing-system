...
const CategoriesManagementPanel = ({
  filteredCategories,
  isMobile,
  loading,
  onCreate,
  ...
  // Renderer kolom dibuat mengikuti pola tabel users/locations agar data master konsisten.
  const columns = [
    {
      title: "No.",
      dataIndex: "id",
        ...
        <Stack spacing={1.6}>
          ...
          >
            ...
            >
              ...
              >
                <Icon icon="tabler:category" fontSize={22} />
              </Box>
              <Box minWidth={0}>
                <FontStyle
                  sx={{
                ...
                >
                  Cari kategori laporan yang tersedia untuk tiket PMCare.
                </FontStyle>
              </Box>
            </Stack>
            ...
            <Button
              ...
              onClick={onCreate}
              startIcon={
                isMobile ? null : <Icon icon="mdi:category-plus" fontSize={20} />
              }
              sx={{
                flexShrink: 0,
                width: { xs: 40, sm: "auto" },
            ...
            >
              {isMobile ? (
                <Icon icon="mdi:category-plus" fontSize={21} />
              ) : (
                "Tambah Kategori"
              )}
            </Button>
          ...
          locale={{
            emptyText: (
              <Box sx={{ py: 4, textAlign: "center" }}>
                ...
                >
                  Coba ubah kata kunci pencarian kategori.
                </FontStyle>
              </Box>
            ),
          }}
